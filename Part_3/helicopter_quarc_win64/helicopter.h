 ...
 * C source code generated on : Mon Feb 03 20:00:47 2020
 *
...
struct P_helicopter_T_ {
  ...
  real_T Vd_ff;                        /* Variable: Vd_ff
                                        * Referenced by: '<S2>/Vd_bias'
                                        */
  real_T Vs_ff;                        /* Variable: Vs_ff
                                        * Referenced by: '<S2>/Vs_bias'
                                        */
  ...
  boolean_T HILInitialize_set_pwm_params__f;/* Mask Parameter: HILInitialize_set_pwm_params__f
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  real_T travel_offset_Value;          /* Expression: pi
                                        * Referenced by: '<Root>/travel_offset'
                                        */
  ...
  real_T elevation_ref_Value;          /* Expression: 0
                                        * Referenced by: '<S2>/elevation_ref'
                                        */
  real_T Backgain_Gain;                /* Expression: 0.5
                                        * Referenced by: '<S3>/Back gain'
                                        */
  real_T Frontgain_Gain;               /* Expression: 0.5
                                        * Referenced by: '<S3>/Front gain'
                                        */
 ...
 *
 * '<Root>' : 'helicopter'
 * '<S1>'   : 'helicopter/Advanced control layer'
 * '<S2>'   : 'helicopter/Basic control layer '
 * '<S3>'   : 'helicopter/Conversion'
 * '<S4>'   : 'helicopter/Degrees to Radians'
 * '<S5>'   : 'helicopter/Helicopter_interface'
 * '<S6>'   : 'helicopter/Basic control layer /Elevation controller'
 * '<S7>'   : 'helicopter/Basic control layer /Pitch controller'
 * '<S8>'   : 'helicopter/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helicopter/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helicopter/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helicopter/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helicopter/Helicopter_interface/Pitch rate rad to deg1'
