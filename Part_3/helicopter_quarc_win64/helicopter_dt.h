...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&helicopter_P.K[0]), 0, 0, 30 },
  ...
  { (char_T *)(&helicopter_P.travel_offset_Value), 0, 0, 32 },
