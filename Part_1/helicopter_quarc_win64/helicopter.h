...
struct P_helicopter_T_ {
  ...
  real_T Gain_Gain_lv;                 /* Expression: 180/pi
                                        ...
                                        */
  real_T elavation_offsetdeg_Value;    /* Expression: -15
 ...
 * '<S11>'  : 'helicopter/Helicopter_interface/Travel rad to deg'
 * '<S12>'  : 'helicopter/Helicopter_interface/Travel rate  rad to deg'
 */
