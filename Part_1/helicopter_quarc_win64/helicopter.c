 ...
 * C source code generated on : Mon Jan 27 14:24:29 2020
 *
...
void helicopter_output(void)
{
   ...
   *  Sum: '<S5>/Sum3'
   */
  helicopter_B.Sum1 = ((helicopter_P.pitch_ref_Value - helicopter_P.Gain1_Gain *
...
RT_MODEL_helicopter_T *helicopter(void)
{
  ...
  /* External mode info */
  helicopter_M->Sizes.checksums[0] = (2483994139U);
  helicopter_M->Sizes.checksums[1] = (75931036U);
  helicopter_M->Sizes.checksums[2] = (2663012262U);
  helicopter_M->Sizes.checksums[3] = (1752507705U);
