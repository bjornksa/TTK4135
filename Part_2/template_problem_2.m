...
% Bounds
ul 	    = -pi*30/180;                   % Lower bound on control
uu 	    =  pi*30/180;                   % Upper bound on control
...
tic
[z,lambda, exit_flag] = quadprog(Q, c, [], [], Aeq, beq, vlb, vub, x0); % hint: quadprog. Type 'doc quadprog' for more info 
t1=toc;
